    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(1200px_500px_at_85%_10%,#E7F0FE_0%,rgba(231,240,254,0)_60%),linear-gradient(180deg,#FAFCFF_0%,#F3F8FF_100%)] before:absolute before:top-[-140px] before:left-[-200px] before:h-[520px] before:w-[520px] before:rounded-full before:border before:border-blue/10 before:content-[''] after:absolute after:right-[-120px] after:bottom-[-180px] after:h-[360px] after:w-[360px] after:rounded-full after:border after:border-blue/10 after:content-['']">
        <div className='relative mx-auto grid max-w-[1180px] grid-cols-[1.02fr_0.98fr] items-center gap-10 px-6 pt-16 pb-10 max-[980px]:grid-cols-1 max-[980px]:pt-11 max-[980px]:pb-8'>
          <div>
            <p className='mb-3.5 text-[15px] font-semibold text-blue'>
              Your Future, Our Learning
            </p>
            <h1 className='mb-4 text-[44px] tracking-[-0.5px] max-[980px]:text-[34px] max-[620px]:text-[28px]'>
              Flexible Online Degrees &amp; Certifications for a Brighter
              Tomorrow
            </h1>
            <p className='mb-7 max-w-[430px] text-base'>
              Study anytime, anywhere with recognised programmes designed for
              your success.
            </p>
          ...
          <div className='relative flex items-end justify-center'>
            <iframe
              className='relative z-10 aspect-video w-[280px] rounded-[18px] border-0 shadow-brand-lg sm:w-[400px] md:w-[500px] lg:w-[600px]'
      ...
      <section className='bg-[linear-gradient(90deg,#1877F2_0%,#0F5FD0_100%)]'>
        <div className='mx-auto grid max-w-[1180px] grid-cols-4 gap-5 px-6 py-[26px] text-white max-[980px]:grid-cols-2 max-[980px]:gap-[22px] '>
          <div className='flex items-center justify-center gap-[14px]'>
            <svg
              className='h-[34px] w-[34px] flex-none stroke-white fill-none [stroke-width:1.6]'
              viewBox='0 0 24 24'
            >
              <circle cx='9' cy='8' r='3.2' />
              <path d='M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6' />
              <path d='M16 6.5a3 3 0 010 5.6M18 20c0-2.5-1-4.5-2.6-5.6' />
            </svg>
            <div>
          ...
          <div className='flex items-center justify-center gap-[14px]'>
            ...
            >
              ...
              <path d='M5 10v5c0 2 3.2 3.5 7 3.5s7-1.5 7-3.5v-5' />
            </svg>
            <div>
          ...
          <div className='flex items-center justify-center gap-[14px]'>
            <svg
              ...
              viewBox='0 0 24 24'
            >
              <path d='M3 20h18M5 20V10m4 10V10m6 10V10m4 10V10M2.5 10L12 4.5 21.5 10z' />
            </svg>
            <div>
      ...
      <section className='px-6 py-[72px] max-[620px]:py-[52px]' id='courses'>
        <div className='mx-auto max-w-[1180px]'>
          <div className={`reveal ${sectionHead} ${revealCls}`}>
            <h2 className='mb-2 text-[30px] max-[620px]:text-2xl'>
              Top Certification &amp; Online Degree Courses
            </h2>
            <p className='text-[15px]'>
              Explore in-demand courses to boost your career and achieve your
              goals.
            </p>
          </div>
      ...
      {/* ================= UNIVERSITIES ================= */}
      <section
        className='px-6 pb-[72px] max-[620px]:pb-[52px]'
        id='universities'
      >
        <div className='mx-auto max-w-[1180px]'>
          <div className={`reveal ${sectionHead} ${revealCls}`}>
            ...
            <p className='text-[15px]'>
              Compare approvals, fees and programmes before you commit.
            </p>
          </div>
          <UniStrip />
        </div>
      ...
      {/* ================= ABOUT ================= */}
      <section
        className='p-6 pb-[72px] max-[620px]:pb-[52px] bg-navy text-white/72 '
        id='about'
      >
        <div className='mx-auto max-w-[1180px]'>
          <div>
            <h2 className='mb-4 text-[30px] text-white max-[620px]:text-2xl text-center'>
              About Distance Education Learning
            </h2>

            <p className='text-[15px] text-center'>
              {' '}
              Distance Education Learning is India's trusted platform dedicated
              to simplifying higher education for students and working
              professionals. We help learners find the right online and distance
              degree programs from recognised, UGC-DEB approved universities —
              without the confusion of scattered information or misleading
              claims.
            </p>

            <p className='text-[15px] text-center'>
              Over time, we've built a reputation as a reliable guide for
              thousands of learners across India. Our focus is on working
              professionals who want to advance their education without pausing
              their careers or personal responsibilities. From university
              comparisons and eligibility checks to personalised counselling and
              transparent fee guidance, we make every step of the journey clear
              and stress-free.
            </p>

            <p className='text-[15px] text-center'>
              Our vision is simple: education should be accessible, credible,
              and built around the learner's real life — not the other way
              around. We don't just recommend degree programs; we take the time
              to understand your goals and guide you toward a choice that
              genuinely fits your career path. We're not just helping you enrol.
              We're helping you grow.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='py-6 pb-[72px] max-[620px]:pb-[52px]'>
        <div className='mx-auto max-w-[1180px]'>
          ...
          <div
            className={`reveal grid grid-cols-3 gap-6 max-[980px]:grid-cols-1 ${revealCls}`}
          >
            <figure className='m-4 flex flex-col gap-[14px] rounded-brand border border-line bg-white p-6 shadow-brand transition-all duration-200 hover:-translate-y-1 hover:shadow-brand-lg'>
              <div className='text-[34px] leading-none font-bold text-[#BFD8FA]'>
                &ldquo;
              </div>
              <p className='text-sm'>
                The flexibility to learn at my own pace helped me balance my
                studies and work.
              </p>
              <figcaption>
            ...
            <figure className='m-4 flex flex-col gap-[14px] rounded-brand border border-line bg-white p-6 shadow-brand transition-all duration-200 hover:-translate-y-1 hover:shadow-brand-lg'>
              ...
              <p className='text-sm'>
                The courses are well-structured and taught by industry experts.
              </p>
              <figcaption>
                <div className='text-sm font-semibold text-ink'>
                  &ndash; Arjun Mehta
            ...
            <figure className='m-4 flex flex-col gap-[14px] rounded-brand border border-line bg-white p-6 shadow-brand transition-all duration-200 hover:-translate-y-1 hover:shadow-brand-lg'>
              ...
              <p className='text-sm'>
                I gained the skills I needed to grow in my career and achieve my
                goals.
              </p>
              <figcaption>
                <div className='text-sm font-semibold text-ink'>
      ...
      <section id='faq' className='py-[70px]'>
        {/* FAQ Heading */}
        <div
          className={`reveal mx-auto mb-[34px] max-w-none text-left ${revealCls}`}
        >
        ...
        {/* FAQ List */}
        <div
          className={`reveal mx-auto my-2 w-full max-w-[900px] overflow-hidden rounded-xl border border-line bg-white md:max-w-[700px] ${revealCls}`}
        >
          <details className='group border-b border-line'>
            <summary className='flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3 text-[13px] font-semibold text-ink md:px-4 md:py-3'>
              <span>How do I enrol in a distance or online degree course?</span>

              <span className='shrink-0 text-[18px] font-normal text-blue transition-transform duration-200 group-open:rotate-45'>
                +
              </span>
            </summary>

            <div className='px-4 pb-4 text-[12px] leading-[1.6] text-body'>
              You can enrol by connecting with our counsellors, who will guide
              you through university selection, eligibility checks,
              documentation, and the complete admission process — making
              enrolment simple and hassle-free.
            </div>
          </details>

          <details className='group border-b border-line'>
            <summary className='flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3 text-[13px] font-semibold text-ink'>
              <span>
          ...
          <details className='group border-b border-line'>
            ...
            <div className='px-4 pb-4 text-[12px] leading-[1.6] text-body'>
              ...
              all from recognised, UGC-DEB approved universities.
            </div>
          </details>
          ...
          <details className='group border-b border-line'>
            ...
            <div className='px-4 pb-4 text-[12px] leading-[1.6] text-body'>
              ...
              from the recognised, UGC-DEB approved university.
            </div>
          </details>
          ...
          <details className='group'>
            ...
            <div className='px-4 pb-4 text-[12px] leading-[1.6] text-body'>
              We verify every university's UGC-DEB approval status before
              listing it on our platform, so you can be confident you're
              choosing a recognised and credible degree program.
            </div>
          </details>
        </div>
      </section>
