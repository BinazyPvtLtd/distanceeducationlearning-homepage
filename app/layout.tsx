...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      'Distance Education Learning | Flexible Online Degrees & Certifications',
    description:
...
const jsonLd = {
  ...
  description:
    'Counselling platform for UGC-DEB approved online and distance degree programmes in India.',
  address: {
    '@type': 'PostalAddress',
        ...
        <LeadModalProvider>
          ...
          <section className='overflow-hidden bg-[linear-gradient(120deg,#0A2A5E_0%,#123B84_100%)] text-white'>
            <div className='mx-auto flex max-w-[1180px] items-center justify-between gap-[30px] px-6 py-11 max-[980px]:flex-col max-[980px]:text-center'>
              <div>
                <h2 className='mb-1.5 text-[26px] text-white'>
              ...
              <LeadTriggerButton className={btnLight}>
